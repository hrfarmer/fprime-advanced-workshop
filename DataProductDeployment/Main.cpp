...
#include <DataProductDeployment/Top/DataProductDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    DataProductDeployment::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    DataProductDeployment::TopologyState inputs;
    inputs.hostname = hostname;
    inputs.port = port_number;
    inputs.bmp.device.device = 0;
    inputs.bmp.device.select = 0;
