module DataProductDeployment {
  ...
  topology DataProductDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "DataProductDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections DataProductDeployment {
      Bmp280.bmpManager.bmpDataPush -> bmpManager.Bmp280DataIn
      bmpManager.Bmp280ProductGet -> DataProducts.dpMgr.productGetIn
      bmpManager.Bmp280ProductSend -> DataProducts.dpMgr.productSendIn
    }
