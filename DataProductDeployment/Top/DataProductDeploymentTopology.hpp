// ======================================================================
// \title  DataProductDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef DATAPRODUCTDEPLOYMENT_DATAPRODUCTDEPLOYMENTTOPOLOGY_HPP
#define DATAPRODUCTDEPLOYMENT_DATAPRODUCTDEPLOYMENTTOPOLOGY_HPP
// Included for access to DataProductDeployment::TopologyState and DataProductDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <DataProductDeployment/Top/DataProductDeploymentTopologyDefs.hpp>
 ...
 * DataProductDeployment::TopologyState see: DataProductDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type DataProductDeployment::TopologyState see: DataProductDeploymentTopologyDefs.hpp.
 *
